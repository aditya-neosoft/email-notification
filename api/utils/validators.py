...
class PhoneNumberValidator(BaseValidator):
    ...
    def __call__(self, value):
        """
            ...
            :return: raises ValidationError or returns value if input is valid US phonenumber
        """
...
class JSONValidator(BaseValidator):
    ...
    def __call__(self, value):
        """
            :param string:
            :return: raises validationError or return cleaned value as dict (valid json object)
        """
        try:
            json.loads(value)
        except ValueError:
